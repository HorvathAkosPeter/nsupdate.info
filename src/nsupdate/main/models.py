...
class Host(models.Model):
    ...
    def get_by_fqdn(cls, fqdn, **kwargs):
        ...
        try:
            ...
            # should not happen, see Meta.constraints
...
class ServiceUpdater(models.Model):
    ...
    port = RangeIntegerField(
        _("Update Server http(s) port to use"),
        default=443,
        min_value=1, max_value=65535,
        help_text=_("Port to use - default is 80 for http and 443 for https"))
